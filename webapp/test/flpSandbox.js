		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Barcode Scanner Asset",
									"targetURL": "#zbarcodescan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbarcodescan-display": {
								"semanticObject": "zbarcodescan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbarcodescan",
									"url": sap.ui.require.toUrl("zbarcodescan")
								}
							}
						}
					}
